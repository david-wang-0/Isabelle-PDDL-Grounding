...
text \<open>Reusable, AST-agnostic formula/valuation and combinatorial helpers from the relaxation
  ...
  on a uniform domain. Mirrors the classical Classical_Reachability_Analysis stage; the datalog/reachability
  locales stay in \<open>Classical_Grounding.Classical_PDDL_Reachability_Locales\<close>.\<close>
