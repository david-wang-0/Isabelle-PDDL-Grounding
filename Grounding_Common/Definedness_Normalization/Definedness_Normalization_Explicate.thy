theory Definedness_Normalization_Explicate
...
text \<open>Reusable, AST-agnostic core of definedness explication: for every PNE appearing in a formula,
  ...
  Definedness_Normalization stage; the action/domain/problem explication and the locales stay in
  \<open>Classical_Grounding.Definedness_Normalization_Locales\<close>.\<close>
